...
def serpentine(input):
    ...
    matrix=np.reshape(x,(8,8))

    lst=[]     ##list to store the values

    i,j=0    ##inizialize the indeces for the matrix
...
x=input("let's run the serpentine algorithm")
serpentine('Practica1.jpg','/mnt/c/users/danie/PycharmProjects/pythonProject/ex4output.jpg')
